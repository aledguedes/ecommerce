...
<main>
    <div class="container mb-5 pt-4">
        <nav style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="home.php" class="text-primary"><i
                            class="bi bi-house-door text-primary me-2"></i> Home</a></li>
    ...
    <section>
        <div class="container">
            <h2 class="text-gradient">Carrinho</h2>
            ...
            <table class="table table-carrinho">
                ...
                <tbody>
                    <tr>
                        <th scope="row"><i class="bi bi-x-circle-fill me-2"></i><img src="/img/img-iphone-2.png"
                                width="40px" alt=""> </th>
